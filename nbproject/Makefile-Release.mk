...
${OBJECTDIR}/UtilConfig.o: UtilConfig.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UtilConfig.o UtilConfig.cpp

${OBJECTDIR}/UtilDateTime.o: UtilDateTime.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UtilDateTime.o UtilDateTime.cpp

${OBJECTDIR}/UtilLogger.o: UtilLogger.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UtilLogger.o UtilLogger.cpp

${OBJECTDIR}/third-party/pugixml/src/pugixml.o: third-party/pugixml/src/pugixml.cpp 
	${MKDIR} -p ${OBJECTDIR}/third-party/pugixml/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/third-party/pugixml/src/pugixml.o third-party/pugixml/src/pugixml.cpp
...
${TESTDIR}/UnitTest/UtilConfigTest.o: UnitTest/UtilConfigTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/UnitTest/UtilConfigTest.o UnitTest/UtilConfigTest.cpp


${TESTDIR}/UnitTest/UtilDateTimeTest.o: UnitTest/UtilDateTimeTest.cpp 
	${MKDIR} -p ${TESTDIR}/UnitTest
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/UnitTest/UtilDateTimeTest.o UnitTest/UtilDateTimeTest.cpp


${TESTDIR}/UnitTest/UtilLoggerTest.o: UnitTest/UtilLoggerTest.cpp 
	${MKDIR} -p ${TESTDIR}/UnitTest
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/UnitTest/UtilLoggerTest.o UnitTest/UtilLoggerTest.cpp


${TESTDIR}/UnitTest/UtilMain.o: UnitTest/UtilMain.cpp 
	${MKDIR} -p ${TESTDIR}/UnitTest
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/UnitTest/UtilMain.o UnitTest/UtilMain.cpp
...
${OBJECTDIR}/UtilConfig_nomain.o: ${OBJECTDIR}/UtilConfig.o UtilConfig.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UtilConfig_nomain.o UtilConfig.cpp;\
	else  \
...
${OBJECTDIR}/UtilDateTime_nomain.o: ${OBJECTDIR}/UtilDateTime.o UtilDateTime.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UtilDateTime_nomain.o UtilDateTime.cpp;\
	else  \
...
${OBJECTDIR}/UtilLogger_nomain.o: ${OBJECTDIR}/UtilLogger.o UtilLogger.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UtilLogger_nomain.o UtilLogger.cpp;\
	else  \
...
${OBJECTDIR}/third-party/pugixml/src/pugixml_nomain.o: ${OBJECTDIR}/third-party/pugixml/src/pugixml.o third-party/pugixml/src/pugixml.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/third-party/pugixml/src/pugixml_nomain.o third-party/pugixml/src/pugixml.cpp;\
	else  \
