...
${OBJECTDIR}/src/FixEngine/FIX50SP2_classes.o: src/FixEngine/FIX50SP2_classes.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/include -Ithird-party/pugixml/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FixEngine/FIX50SP2_classes.o src/FixEngine/FIX50SP2_classes.cpp

${OBJECTDIR}/src/FixEngine/FIX50SP2_traits.o: src/FixEngine/FIX50SP2_traits.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/FixEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/include -Ithird-party/pugixml/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FixEngine/FIX50SP2_traits.o src/FixEngine/FIX50SP2_traits.cpp

${OBJECTDIR}/src/FixEngine/FIX50SP2_types.o: src/FixEngine/FIX50SP2_types.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/FixEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/include -Ithird-party/pugixml/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FixEngine/FIX50SP2_types.o src/FixEngine/FIX50SP2_types.cpp

${OBJECTDIR}/src/Utilities/UtilConfig.o: src/Utilities/UtilConfig.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Utilities
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/include -Ithird-party/pugixml/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Utilities/UtilConfig.o src/Utilities/UtilConfig.cpp

${OBJECTDIR}/src/Utilities/UtilDateTime.o: src/Utilities/UtilDateTime.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Utilities
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/include -Ithird-party/pugixml/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Utilities/UtilDateTime.o src/Utilities/UtilDateTime.cpp

${OBJECTDIR}/src/Utilities/UtilLogger.o: src/Utilities/UtilLogger.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Utilities
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/include -Ithird-party/pugixml/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Utilities/UtilLogger.o src/Utilities/UtilLogger.cpp
...
${OBJECTDIR}/src/FixEngine/FIX50SP2_classes_nomain.o: ${OBJECTDIR}/src/FixEngine/FIX50SP2_classes.o src/FixEngine/FIX50SP2_classes.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I/usr/local/include -Ithird-party/pugixml/src -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FixEngine/FIX50SP2_classes_nomain.o src/FixEngine/FIX50SP2_classes.cpp;\
	else  \
...
${OBJECTDIR}/src/FixEngine/FIX50SP2_traits_nomain.o: ${OBJECTDIR}/src/FixEngine/FIX50SP2_traits.o src/FixEngine/FIX50SP2_traits.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I/usr/local/include -Ithird-party/pugixml/src -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FixEngine/FIX50SP2_traits_nomain.o src/FixEngine/FIX50SP2_traits.cpp;\
	else  \
...
${OBJECTDIR}/src/FixEngine/FIX50SP2_types_nomain.o: ${OBJECTDIR}/src/FixEngine/FIX50SP2_types.o src/FixEngine/FIX50SP2_types.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I/usr/local/include -Ithird-party/pugixml/src -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FixEngine/FIX50SP2_types_nomain.o src/FixEngine/FIX50SP2_types.cpp;\
	else  \
...
${OBJECTDIR}/src/Utilities/UtilConfig_nomain.o: ${OBJECTDIR}/src/Utilities/UtilConfig.o src/Utilities/UtilConfig.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I/usr/local/include -Ithird-party/pugixml/src -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Utilities/UtilConfig_nomain.o src/Utilities/UtilConfig.cpp;\
	else  \
...
${OBJECTDIR}/src/Utilities/UtilDateTime_nomain.o: ${OBJECTDIR}/src/Utilities/UtilDateTime.o src/Utilities/UtilDateTime.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I/usr/local/include -Ithird-party/pugixml/src -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Utilities/UtilDateTime_nomain.o src/Utilities/UtilDateTime.cpp;\
	else  \
...
${OBJECTDIR}/src/Utilities/UtilLogger_nomain.o: ${OBJECTDIR}/src/Utilities/UtilLogger.o src/Utilities/UtilLogger.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I/usr/local/include -Ithird-party/pugixml/src -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Utilities/UtilLogger_nomain.o src/Utilities/UtilLogger.cpp;\
	else  \
